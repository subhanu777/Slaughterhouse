...
/**
 *  RegisterProduct bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RegisterProduct implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":registerProduct", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "registerProduct", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static RegisterProduct parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RegisterProduct object = new RegisterProduct();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"registerProduct".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RegisterProduct) tier2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
