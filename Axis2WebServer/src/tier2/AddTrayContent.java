...
/**
 *  AddTrayContent bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class AddTrayContent implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":addTrayContent", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "addTrayContent", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static AddTrayContent parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            AddTrayContent object = new AddTrayContent();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"addTrayContent".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (AddTrayContent) tier2.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://tier2", "args2").equals(
                            reader.getName())) ||
