        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("getInfectedProducts".equals(methodName)) {
                    webserver.GetInfectedProductsResponse getInfectedProductsResponse27 =
                        null;
                    webserver.GetInfectedProducts wrappedParam = (webserver.GetInfectedProducts) fromOM(msgContext.getEnvelope()
                                                                                                                  .getBody()
                                                                                                                  .getFirstElement(),
                            webserver.GetInfectedProducts.class);
